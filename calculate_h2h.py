...
# Alternatively, uncomment the following line and add your information:
...
DEFAULT_ELO = 0 # Starting elo for players
...
def parse_tourney(tourney_id):
    ...
    for participant in participants:
        ...
        if not name in players_by_name:
            ...
            players_by_name[name] = Player(name, DEFAULT_ELO, 0, 0, 0, 0)
